sap.ui.define(["sap/ui/model/Filter", "sap/ui/model/FilterOperator"], function (Filter, FilterOperator) {
	...
	return {
		 ...
		 * @returns {number} number of not deleted questions
		 */
		formQuestionsCounterTooltip: function (aQuestions) {
			var sPath = this.getContext().getPath() + "/Questions";
			var oBindings = this.getModel().bindList(sPath, null, null, [new Filter({
				path: "Deleted",
				operator: FilterOperator.EQ,
				value1: false
			})]);
...
}, /*For exporting*/ true); // <-- Enables accessing this module via global name "com.mjzsoft.QuestionnaireStatistics.model.individualFormatter"