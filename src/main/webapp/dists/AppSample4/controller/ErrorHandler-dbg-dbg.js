sap.ui.define([
	...
	return UI5Object.extend("com.mjzsoft.Survey.controller.ErrorHandler", {
		 ...
		 * @public
		 * @alias com.mjzsoft.Survey.controller.ErrorHandler
		 */
		...
		_showServiceError: function (oDetails) {
			...
			try {
				...
				//
				try {
					var oX2JS = new XML2JSON.X2JS();
					oMessage = oX2JS.XMLStr2JSON(oDetails.responseText);
