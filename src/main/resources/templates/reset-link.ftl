                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            style="padding: 20px 35px 5px; text-align: left; color: #6f6f6f; font-family: sans-serif; border-top: 0;">
                                            <div style="text-align: center; padding-bottom: 80px;">
                                            	<img src="https://avatars.githubusercontent.com/u/17589252" alt="MJZSoft Logo">
                                            </div>
                                            <h1 class="tw-h1"
                                            ...
                                            <span style="font-weight: 400;">Please click the below button to change your password for <strong>MJZSoft Engagement App</strong>.The link will be valid for next ${expirationTime} minutes.</span><br/><br/><span
                                            ...
                                            <p class=""
                                               style="margin: 20px 0; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Contact our support team if you have any questions or concerns.&nbsp;<a
                                                    ...
                                                    href="https://www.mjzsoft.com/contact/" target="_blank" rel="noopener">Ask us any
                                                question</a></p>
                                            <p class="tw-signoff"
                                               style="margin: 45px 0 5px; font-size: 16px; mso-line-height-rule: exactly; line-height: 24px;">
                                                Our best, <br/> The MJZSoft Engagement App team</p>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
